...
INSERT INTO `host_vacants` (`host_id`, `vacant_date_start`, `vacant_date_end`, `vacant_count`)
VALUES
...
INSERT INTO `host_comments` (`host_id`, `user_id`,  `comment_content`, `create_date`)
VALUES
    (1,1,'my first comment to my first host','20220614');
