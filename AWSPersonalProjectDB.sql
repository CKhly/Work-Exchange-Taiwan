...
INSERT INTO `host_table` (`host_name`, `host_contacts`, `host_mainImage`, `host_category`, `host_location`, `host_lng`,`host_lat`, `host_gender_needs`, `short_period`, `host_description`, `host_needs`, `host_benefits`, `host_creator_id`, `host_create_date`, `host_last_update_date`, `host_likes`, `host_others`)
VALUES
